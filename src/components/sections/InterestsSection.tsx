...
export function InterestsSection() {
    ...
    return (
        <Box textAlign={'left'} border={'1px'} borderColor={theme.interestsBoxColor}>
            <Box backgroundColor={theme.interestsBoxColor} paddingStart={'10px'}>
                <Text fontWeight={'bold'} color={theme.interestsHeaderTextColor} fontSize={'1.5em'} textAlign={'left'}>
                    Kyle's Interests
                </Text>
            </Box>
            <Grid templateColumns={'repeat(4, 1fr)'} gap={1} paddingStart={1} paddingTop={1} paddingBottom={1} paddingEnd={1}>
                <GridItem colSpan={1} backgroundColor={theme.interestsBgColor} paddingStart={1} textColor={theme.interestsTopicTextColor}>
                    books
                </GridItem>
                <GridItem colSpan={3} backgroundColor={theme.interestsBgColor} textColor={theme.interestsMainTextColor} paddingStart={1} paddingEnd={1} paddingTop={1} paddingBottom={1}>
